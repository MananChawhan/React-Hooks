...
import { FaReact, FaSitemap, FaRegSave } from 'react-icons/fa';
...
const Home = () => {
  ...
  const pages = [
    { label: "Parent Component", path: "/parentcomponent", icon: <FaSitemap className="text-xl mr-2" /> },
    { label: "Coming Soon...", path: "/", icon: <AiOutlineClockCircle className="text-xl mr-2" /> },
    { label: "Coming Soon...", path: "/otp", icon: <FaRegSave className="text-xl mr-2" /> },
    { label: "Coming Soon...", path: "/wallpaper", icon: <MdWallpaper className="text-xl mr-2" /> },
  ];
